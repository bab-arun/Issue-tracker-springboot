...
public class Department implements Serializable {
	...
	public Department(int id, String name, LocalDate createdOn, String createdBy, LocalDate modifiedOn, String modifiedBy,
			boolean active, List<UserDepartment> userDepartment, List<Issue> issue) {
		super();
		this.id = id;
		this.name = name;
